...
export function RegionAdvanced({ code }: { code: string }) {
  ...
  return <div className="advanced-region"><TimelinePanel code={code} />
    <section id="financiamento"><h2>Recursos gerais da saúde</h2>
      ...
      <p className="small-text">Valores em reais correntes do respectivo exercício; comparações entre anos não representam variação real descontada da inflação.</p><Link href="/financiamento">Explorar recursos de saúde</Link></section>
