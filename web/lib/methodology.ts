export const METHOD_IDENTIFIERS = {
  ...
  release: "MDB_ANALYTICAL_2024_2",
  canonical: "MDB_CANONICAL_1.1",
...
export const SCIENTIFIC_SOURCES = {
  release: "metadata/releases/MDB_ANALYTICAL_2024_2.yaml",
  canonical: "metadata/releases/MDB_ANALYTICAL_2024_2_canonical.yaml",
  serving: "metadata/releases/MDB_ANALYTICAL_2024_2_serving.yaml",
